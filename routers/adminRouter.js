...
router.get('/assign/:level/:AssignSchedule_id', assignController.readAssignDetail);
...
router.post('/assign/:level/:AssignSchedule_id/delete', assignController.deleteAssign);
router.get('/assign/:level/:AssignSchedule_id/:AssignUserId/create', assignController.readGrade);
router.post('/assign/:level/:AssignSchedule_id/:AssignUserId/create', assignController.createGrade);
